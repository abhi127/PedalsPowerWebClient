...
@Component({
  selector: 'app-centuary-cycling',
  templateUrl: './centuary-cycling.component.html',
  styleUrls: ['./centuary-cycling.component.scss']
})
export class CentuaryCyclingComponent implements OnInit {
  lastScrollTop = 0;
